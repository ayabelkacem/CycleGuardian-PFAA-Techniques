...
# Optional: ACGAN synthetic samples (saved as .pt with keys {'x','y'})
parser.add_argument('--synthetic_train_pt', type=str, default=None,
                    help='Optional path to .pt generated by generate_acgan_samples.py to append to training data')
...
class Trainer:
    def __init__(self):
        ...
        if self.args.synthetic_train_pt:
            from torch.utils.data import ConcatDataset
            from data.pt_tensor_dataset import PTTensorDataset
            synth_dataset = PTTensorDataset(self.args.synthetic_train_pt)
            train_dataset = ConcatDataset([train_dataset, synth_dataset])
            print(f"[Synthetic] Appended {len(synth_dataset)} samples from {self.args.synthetic_train_pt}")
